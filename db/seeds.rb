...
user1 = Volunteer.create(name: "Mariya Rojano", phone: "619-123-4567", opportunity_id: opp1.id)
user2 = Volunteer.create(name: "Blake Thomas", phone: "659-673-4527", opportunity_id: opp2.id)
user3 = Volunteer.create(name: "Mike Brown", phone: "339-183-4567", opportunity_id: opp3.id)
user4 = Volunteer.create(name: "Sandra Reynolds", phone: "613-423-4467", opportunity_id: opp4.id)
